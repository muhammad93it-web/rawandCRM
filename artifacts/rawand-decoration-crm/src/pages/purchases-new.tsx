  ...
  return (
    <div dir="rtl" className="pb-10 min-h-screen">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-800">زیادکردنی پسوولەی کڕین</h1>
      </div>
      ...
      <div className="crm-dense-panel mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            <label className="crm-dense-label">وەرگر</label>
            <div className="flex items-center h-[28px]">
              <select
                className="w-full border border-gray-300 border-l-0 px-2 text-[13px] outline-none focus:border-[#0f4c81] rounded-r-sm bg-white"
                value={receiver}
      ...
      <div className="flex justify-end">
        ...
        >
          ...
          {createPurchase.isPending ? "لە پرۆسەدایە..." : "پاشەکەوت کردن"}
        </button>
      </div>
    </div>
  );

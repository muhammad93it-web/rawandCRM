...
function generic_crud(string $method,string $table,string $resource,?int $id): never {
    $pdo=db();
    $soft=in_array($table,['brands','item_series','warehouses','services','business_documents','account_categories','cash_boxes','financial_entries','module_settings','workplaces','user_groups','users','employees','drivers'],true);
